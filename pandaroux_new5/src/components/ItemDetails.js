...
import { ArrowLeft, ExternalLink, TrendingDown, Leaf, Package, CheckCircle, ShoppingBag } from 'lucide-react';
import './ItemDetails.css';

const ItemDetails = ({ item, onBack, onAddToWardrobe, isInWardrobe, onGoHome, wardrobeCount }) => {
