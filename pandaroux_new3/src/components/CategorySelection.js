...
const CategorySelection = ({ onCategorySelect, onBack }) => {
  return (
    <div className="category-selection">
      ...
      {/* Quick Access */}
      <div className="quick-access slide-up" style={{ animationDelay: '400ms' }}>
        <h3 className="quick-access-title">Récemment utilisé</h3>
        <div className="recent-categories">
          <div className="recent-item">
            <span className="recent-icon">👕</span>
            <span className="recent-name">Hauts</span>
          </div>
          <div className="recent-item">
            <span className="recent-icon">👟</span>
            <span className="recent-name">Chaussures</span>
          </div>
        </div>
      </div>
    </div>
