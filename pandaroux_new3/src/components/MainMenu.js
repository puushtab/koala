...
const MainMenu = ({ onAddItem, wardrobeItems, onRemoveItem }) => {
    ...
    <div className="main-menu">
      ...
      <div className="wardrobe-section slide-up" style={{ animationDelay: '100ms' }}>
        <div className="section-header">
          <h2 className="section-title">Ma Garde-Robe</h2>
        ...
        {wardrobeItems.length === 0 ? (
          <div className="wardrobe-grid">
            <div className="empty-state">
              ...
              <p className="empty-subtext">Commencez à ajouter vos habits pour créer des outfits parfaits</p>
            </div>
          </div>
        ) : (
